...
public class RelPedido {
    ...
    public static void setFileImported(boolean fileImported) {
        RelPedido.fileImported = fileImported;
    }
    ...
    private static void exportFiles() {
        ...
        String files[] = new String[]{"Pedido.jasper", "Pedido_item.jasper", "Pedido_item_banho.jasper"};
    ...
    public static JasperPrint imprimirPedido(JRDataSource JPRPedidoDataSource) {
        ...
        try {
            ...
            JasperPrint fillReport = JasperFillManager.fillReport(PATH + File.separatorChar + "Pedido.jasper", map, JPRPedidoDataSource);
